#!/bin/bash
# Test Server Deployment Script for HollowPress
...
DEPLOY_PATH="/var/www/hollowpress"
PHP_VERSION="8.3"
...
if command -v supervisorctl &> /dev/null; then
    ...
    sudo supervisorctl restart hollowpress-worker:* 2>/dev/null || echo "No queue workers configured yet"
fi
...
echo "=================================="
echo "🌐 Your site should now be live at test-hollowpress.yourdomain.com"
