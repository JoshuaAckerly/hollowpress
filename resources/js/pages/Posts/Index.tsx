    ...
    return (
        <MainLayout>
            <Head title="Creative Stories">
                <meta
                    name="description"
                    content="Explore creative stories and blog posts from independent artists and creators. Discover unique perspectives, artistic journeys, and unconventional narratives."
                />
                    ...
                    <div className="mx-auto max-w-7xl px-6 py-16">
                        <div className="text-center">
                            ...
                            <Link
                                ...
                                className="inline-flex transform items-center rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 px-8 py-4 font-semibold text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:from-blue-500 hover:to-cyan-500 hover:shadow-xl"
                            >
                ...
                <div className="mx-auto max-w-7xl px-6 py-12">
                        ...
                        {posts.data.map((post, _index) => (
                            ...
                            >
                                ...
                                <div className="relative p-6 pb-4">
                                    {/* Demo Badge */}
                                    {post.is_demo && (
                                        <div className="absolute top-4 right-4 flex items-center gap-1 rounded-full bg-blue-600 px-3 py-1 text-xs font-bold text-white shadow-lg">
                                            <span>🎯</span>
                                            DEMO
                                        </div>
                                    )}
                                    ...
                                    <div className="mb-4 flex items-start justify-between">
                                        <div className="flex-1">
                                            <h2 className="mb-2 line-clamp-2 text-xl font-bold text-gray-200 transition-colors duration-300 group-hover:text-gray-100">
                                                {post.title}
                                            </h2>
                                ...
                                <div className="px-6 pb-6">
                                    <div className="flex items-center justify-between">
                                        <Link
                                            href={`/posts/${post.id}`}
                                            className="group inline-flex items-center font-medium text-gray-400 transition-colors hover:text-gray-200"
                                        >
                                            Read Story
                                            <svg
                    ...
                    {posts.data.length === 0 && (
                        <div className="py-16 text-center">
                            ...
                            <h3 className="mb-2 text-xl font-semibold text-gray-200">No stories yet</h3>
                            <p className="mb-6 text-gray-400">Be the first to share your creative journey</p>
                            <Link
                                href="/demo/posts/create"
