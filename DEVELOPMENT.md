...
- **Vite Dev Server**: http://localhost:5179
- **SSR Server**: http://localhost:13720
...
5. **Start Servers**
   ...
   # Terminal 3: SSR
   php artisan inertia:start-ssr --port=13720
   ```
...
|---------|------|---------|
| Laravel | 8001 | Main application server |
| Vite | 5179 | Development build server with HMR |
| SSR | 13720 | Inertia.js server-side rendering |
...
3. Ensure database exists: `CREATE DATABASE hollowpress;`
4. Run migrations: `php artisan migrate`

### SSR Not Working

1. Verify `.env` has `INERTIA_SSR_ENABLED=true`
2. Check SSR server is running on port 13720
